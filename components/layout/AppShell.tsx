...
export function AppShell({
  ...
  return (
    <div className="min-h-screen" data-focus-layer-root>
      ...
      <main data-app-shell-main className={`relative px-2.5 pb-32 pt-2.5 sm:px-4 sm:pb-28 sm:pt-3 ${activeModule === "dashboard" ? "dashboard-viewport" : activeModule === "finance" ? "finance-viewport" : activeModule === "operations" || activeModule === "hr" ? "operations-viewport" : ""}`}>
