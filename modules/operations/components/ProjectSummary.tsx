...
export function ProjectSummary({ project }: { project: OperationProject }) {
  return (
    <article className="mether-scroll mether-surface h-full min-h-0 overflow-y-auto rounded-[22px] p-2.5">
      ...
      <div className="mt-1.5 grid grid-cols-2 gap-1.5"><SummaryValue label="Workflow" value={project.workflowState} /><SummaryValue label="Son İşlem" value={project.latestOperation} /></div>
