...
export function FinanceHero() {
  return (
    <header className="mether-surface relative overflow-hidden rounded-[26px] p-5 sm:p-7 xl:p-5">
      ...
      <div className="relative flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-3 text-3xl font-black tracking-[-0.045em] text-white sm:text-[38px] xl:text-[34px]">Finans Merkezi</h1>
          <p className="mt-3 max-w-2xl text-xs leading-6 text-slate-400 sm:text-[13px] xl:mt-2 xl:leading-5">
