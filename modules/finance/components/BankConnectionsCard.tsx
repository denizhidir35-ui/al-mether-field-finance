...
export function BankConnectionsCard({ providers }: { providers: readonly BankProviderDefinition[] }) {
  return (
    <FinanceComingSoonCard eyebrow="Secure Banking Architecture" title="Bank Integration Layer" icon={Network} footer={<p className="rounded-xl border border-white/[0.055] bg-black/10 px-3 py-3 text-[10px] leading-5 text-slate-500 xl:py-2 2xl:px-2 2xl:py-1 2xl:text-[9px] 2xl:leading-4">Banka bağlantıları ilerleyen sürümlerde güvenli API katmanı üzerinden aktif edilecektir.</p>}>
